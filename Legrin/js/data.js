const BARBEROS = ['Leider V.', 'Andres M. "Gringo"', 'Freddy R "Dobby"', 'Felipe M. "Tyga"', 'Juan Diaz "Polo"'];
const HORARIOS_DIA = {
...
const products = [
    ...
    { id: 4, name: 'Perfumes',        price: '$15.000', image: 'https://images.unsplash.com/photo-1596510915361-a3a33ead002e?w=400&h=400&fit=crop', description: 'Suave y protector' },
    { id: 5, name: 'Primitivos Men',  price: '$45.000', image: 'https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=400&h=400&fit=crop', description: 'Efecto mate natural' },
];
